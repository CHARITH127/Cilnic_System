...
public class PeadiatricClinicFormContrller {
    public AnchorPane PeadiatricClinicContext;
    ...
    public JFXButton btnPeadiatricClinicAdmit;
    public JFXButton btnPeadiatricClinicGoHome;
    public JFXButton btnPeadiatricClinicUpdate;
    public Date date;
    ...
    public void AddPatientsToClinics(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../view/AddPatientToPeadiatricClinic.fxml"));
        root=loader.load();
        AddPatientToPeadiatricClinicController patient = loader.getController();
    ...
    public void SearchOnPatientHistory(ActionEvent actionEvent) {
        try {
            ObservableList<PatienHistoryTm> patientHistory =
                    new PatientInPeadiatricClinic().getPatientHistory(txtpatientHistorySearch.getText());
    ...
    public void ToAdmit(ActionEvent actionEvent) {
        ...
        try {
            if (new PatientInPeadiatricClinic().addPatientToSearchAdmission(patien)) {
    ...
    public void DeleteThePatientDetails(ActionEvent actionEvent) {
        try {
            if (new PatientInPeadiatricClinic().deletePatientOnClinic(txtPatientID.getText())) {
    ...
    public void UpdateTheClinicTable(ActionEvent actionEvent) {
        ...
        if (new PatientInPeadiatricClinic().updatePatient(patient)) {
        ...
        new ReportsConroller().showUpdateReport("PEADIATRIC CLINIC",txtPatientID.getText(),
                txtPatientName.getText(),txtPatientAge.getText(),txtPatientReason.getText(),txtPatientIllness.getText(),
                txtPatientReports.getText(),txtPatientMedicines.getText(),lblClinicDoctorID.getText(),date);
    ...
    public void loadPatinet(ActionEvent actionEvent) {

        try {
            SearchPatien patient = new PatientInPeadiatricClinic().getPatient(txtPatientID.getText());
