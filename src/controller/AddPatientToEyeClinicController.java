...
public class AddPatientToEyeClinicController {
    ...
    public void initialize(){
        ...
        btnAddPatientADD.setDisable(true);
        storeValidation();
    ...
    public void AddPAtientToTheClinic(ActionEvent actionEvent) {
        ...
        if (new PatientInEyeClinic().addPatientDirectly(patient)) {
            try {
                if (new PatientInEyeClinic().upDatePatientRefernece(reference)) {
    ...
    public void canselTheStage(ActionEvent actionEvent) {
        Stage window =
                (Stage) btnAddPAtientCanel.getScene().getWindow();
        window.close();
    }
}
