...
public class AddPatientToMedicalClinicController {
    ...
    public void AddPAtientToTheClinic(ActionEvent actionEvent) {
        ...
        if (new PatientInMedicalClinic().addPatientDirectly(patient)) {
            try {
                if (new PatientInMedicalClinic().upDatePatientRefernece(reference)) {
