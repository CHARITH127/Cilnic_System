...
public class AddPatientToENTClinicController {
    ...
    public void AddPAtientToTheClinic(ActionEvent actionEvent) {
        ...
        if (new PatientInENTClinic().addPatientDirectly(patient)) {
            try {
                if (new PatientInENTClinic().upDatePatientRefernece(reference)) {
