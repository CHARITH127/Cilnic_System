...
public class AddPatientToFamilyMedicalClinicController {
    ...
    public void AddPAtientToTheClinic(ActionEvent actionEvent) {
        ...
        if (new PatientInFamilyMedicalClinic().addPatientDirectly(patient)) {
            try {
                if (new PatientInFamilyMedicalClinic().upDatePatientRefernece(reference)) {
