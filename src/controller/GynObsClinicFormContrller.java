...
public class GynObsClinicFormContrller {
    public AnchorPane GynObsClinicContext;
    ...
    public JFXButton btnGynObsClinicAdmit;
    public JFXButton btnGynObsClinicGoHome;
    public JFXButton btnGynObsClinicUpdate;
    public Date date;
    ...
    public void AddPatientsToClinics(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../view/AddPatientToGynObsClinic.fxml"));
        root=loader.load();
        AddPatientToGynObsClinicController patient = loader.getController();
    ...
    public void SearchOnPatientHistory(ActionEvent actionEvent) {
        ...
        try {
            ObservableList<PatienHistoryTm> patientHistory =
                    new PatientInGynObsClinic().getPatientHistory(txtpatientHistorySearch.getText());
    ...
    public void ToAdmit(ActionEvent actionEvent) {
        ...
        try {
            if (new PatientInGynObsClinic().addPatientToSearchAdmission(patien)) {
    ...
    public void DeleteThePatientDetails(ActionEvent actionEvent) {
        ...
        try {
            if (new PatientInGynObsClinic().deletePatientOnClinic(txtPatientID.getText())) {
    ...
    public void UpdateTheClinicTable(ActionEvent actionEvent) {
        ...
        if (new PatientInGynObsClinic().updatePatient(patient)) {
        ...
        new ReportsConroller().showUpdateReport("GYN & OBS CLINIC",txtPatientID.getText(),
                txtPatientName.getText(),txtPatientAge.getText(),txtPatientReason.getText(),txtPatientIllness.getText(),
                txtPatientReports.getText(),txtPatientMedicines.getText(),lblClinicDoctorID.getText(),date);
    ...
    public void loadPatien(ActionEvent actionEvent) {
        try {
            SearchPatien patient = new PatientInGynObsClinic().getPatient(txtPatientID.getText());
