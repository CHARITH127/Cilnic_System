...
public class AddPatientToWellBabyClinicController {
    ...
    public void AddPAtientToTheClinic(ActionEvent actionEvent) {
        ...
        if (new PatientInWellBabyClinic().addPatientDirectly(patient)) {
            try {
                if (new PatientInWellBabyClinic().upDatePatientRefernece(reference)) {
