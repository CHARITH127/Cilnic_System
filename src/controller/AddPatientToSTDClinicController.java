...
public class AddPatientToSTDClinicController {
    ...
    public void AddPAtientToTheClinic(ActionEvent actionEvent) {
        ...
        if (new PatientInSTDClinic().addPatientDirectly(patient)) {
            try {
                if (new PatientInSTDClinic().upDatePatientRefernece(reference)) {
