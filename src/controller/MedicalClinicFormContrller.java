...
public class MedicalClinicFormContrller {
    public AnchorPane MedicalClinicContext;
    ...
    public JFXButton btnMedicalClinicAdmit;
    public JFXButton btnMedicalClinicGoHome;
    public JFXButton btnMedicalClinicUpdate;
    public Date date;
    ...
    public void AddPatientsToClinics(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../view/AddPatientToMedicalClinic.fxml"));
        root=loader.load();
        AddPatientToMedicalClinicController patient = loader.getController();
    ...
    public void SearchOnPatientHistory(ActionEvent actionEvent) {
        ...
        try {
            ObservableList<PatienHistoryTm> patientHistory =
                    new PatientInMedicalClinic().getPatientHistory(txtpatientHistorySearch.getText());
    ...
    public void ToAdmit(ActionEvent actionEvent) {
        ...
        try {
            if (new PatientInMedicalClinic().addPatientToSearchAdmission(patien)) {
    ...
    public void DeleteThePatientDetails(ActionEvent actionEvent) {
        try {
            if (new PatientInMedicalClinic().deletePatientOnClinic(txtPatientID.getText())) {
    ...
    public void UpdateTheClinicTable(ActionEvent actionEvent) {
        ...
        if (new PatientInMedicalClinic().updatePatient(patient)) {
        ...
        new ReportsConroller().showUpdateReport("MEDICAL CLINIC",txtPatientID.getText(),
                txtPatientName.getText(),txtPatientAge.getText(),txtPatientReason.getText(),txtPatientIllness.getText(),
                txtPatientReports.getText(),txtPatientMedicines.getText(),lblClinicDoctorID.getText(),date);
    ...
    public void loadPatientDetails(ActionEvent actionEvent) {
        ...
        try {
            SearchPatien patient = new PatientInMedicalClinic().getPatient(txtPatientID.getText());
