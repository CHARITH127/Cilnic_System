...
public class AddPatientToGynObsClinicController {
    ...
    public void AddPAtientToTheClinic(ActionEvent actionEvent) {
        ...
        if (new PatientInGynObsClinic().addPatientDirectly(patient)) {
            try {
                if (new PatientInGynObsClinic().upDatePatientRefernece(reference)) {
    ...
    public void on_key_Releaced(KeyEvent keyEvent) {
