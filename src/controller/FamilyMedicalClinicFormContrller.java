...
public class FamilyMedicalClinicFormContrller {
    public AnchorPane FamilyMedicalClinicContext;
    ...
    public JFXButton btnFamilyMedicalClinicAdmit;
    public JFXButton btnFamilyMedicalClinicGoHome;
    public JFXButton btnFamilyMedicalClinicUpdate;
    public Date date;
    ...
    public void AddPatientsToClinics(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../view/AddPatientToFamilyMedicalClinic.fxml"));
        root=loader.load();
        AddPatientToFamilyMedicalClinicController patient = loader.getController();
    ...
    public void SearchOnPatientHistory(ActionEvent actionEvent) {
        ...
        try {
            ObservableList<PatienHistoryTm> patientHistory =
                    new PatientInFamilyMedicalClinic().getPatientHistory(txtpatientHistorySearch.getText());
    ...
    public void ToAdmit(ActionEvent actionEvent) {
        ...
        try {
            if (new PatientInFamilyMedicalClinic().addPatientToSearchAdmission(patien)) {
    ...
    public void DeleteThePatientDetails(ActionEvent actionEvent) {
        ...
        try {
            if (new PatientInFamilyMedicalClinic().deletePatientOnClinic(txtPatientID.getText())) {
    ...
    public void UpdateTheClinicTable(ActionEvent actionEvent) {
        ...
        if (new PatientInFamilyMedicalClinic().updatePatient(patient)) {
        ...
        new ReportsConroller().showUpdateReport("FAMILY MEDICAL CLINIC",txtPatientID.getText(),
                txtPatientName.getText(),txtPatientAge.getText(),txtPatientReason.getText(),txtPatientIllness.getText(),
                txtPatientReports.getText(),txtPatientMedicines.getText(),lblClinicDoctorID.getText(),date);
        clearAll();
    ...
    public void loadPatient(ActionEvent actionEvent) {
        ...
        try {
            SearchPatien patient = new PatientInFamilyMedicalClinic().getPatient(txtPatientID.getText());
