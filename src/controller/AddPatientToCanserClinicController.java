...
public class AddPatientToCanserClinicController {
    ...
    public void AddPAtientToTheClinic(ActionEvent actionEvent) {
        ...
        if (new PatientInCancerClinic().addPatientDirectly(patient)) {
            try {
                if (new PatientInCancerClinic().upDatePatientRefernece(reference)) {
    ...
    public void closeSatge(ActionEvent actionEvent) {
