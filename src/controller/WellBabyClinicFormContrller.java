...
public class WellBabyClinicFormContrller {
    public AnchorPane WellBabyClinicContext;
    ...
    public JFXButton btnWellBbyClinicAdmit;
    public JFXButton btnWellBbyClinicGoHome;
    public JFXButton btnWellBbyClinicUpdate;
    public Date date;
    ...
    public void AddPatientsToClinics(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../view/AddPatientToWellBabyClinic.fxml"));
        root=loader.load();
        AddPatientToWellBabyClinicController patient = loader.getController();
    ...
    public void SearchOnPatientHistory(ActionEvent actionEvent) {
        ...
        try {
            ObservableList<PatienHistoryTm> patientHistory =
                    new PatientInWellBabyClinic().getPatientHistory(txtpatientHistorySearch.getText());
    ...
    public void ToAdmit(ActionEvent actionEvent) {
        ...
        try {
            if (new PatientInWellBabyClinic().addPatientToSearchAdmission(patien)) {
    ...
    public void DeleteThePatientDetails(ActionEvent actionEvent) {
        ...
        try {
            if (new PatientInWellBabyClinic().deletePatientOnClinic(txtPatientID.getText())) {
    ...
    public void UpdateTheClinicTable(ActionEvent actionEvent) {
        ...
        if (new PatientInWellBabyClinic().updatePatient(patient)) {
        ...
        new ReportsConroller().showUpdateReport("WELL BABY CLINIC",txtPatientID.getText(),
                txtPatientName.getText(),txtPatientAge.getText(),txtPatientReason.getText(),txtPatientIllness.getText(),
                txtPatientReports.getText(),txtPatientMedicines.getText(),lblClinicDoctorID.getText(),date);
    ...
    public void loadPatinet(ActionEvent actionEvent) {
        ...
        try {
            SearchPatien patient = new PatientInWellBabyClinic().getPatient(txtPatientID.getText());
