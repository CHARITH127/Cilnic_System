...
public class SurgicalClinicFormContrller {
    public AnchorPane SurgicalClinicContext;
    ...
    public JFXButton btnSurgicalClinicAdmit;
    public JFXButton btnSurgicalClinicGoHome;
    public JFXButton btnSurgicalClinicUpdate;
    public Date date;
    ...
    public void AddPatientsToClinics(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../view/AddPatientToSurgicalClinic.fxml"));
        root=loader.load();
        AddPatientToSurgicalClinicController patient = loader.getController();
    ...
    public void SearchOnPatientHistory(ActionEvent actionEvent) {
        try {
            ObservableList<PatienHistoryTm> patientHistory =
                    new PatientInSurgicalClinic().getPatientHistory(txtpatientHistorySearch.getText());
    ...
    public void ToAdmit(ActionEvent actionEvent) {
        ...
        try {
            if (new PatientInSurgicalClinic().addPatientToSearchAdmission(patien)) {
    ...
    public void DeleteThePatientDetails(ActionEvent actionEvent) {
        try {
            if (new PatientInSurgicalClinic().deletePatientOnClinic(txtPatientID.getText())) {
    ...
    public void UpdateTheClinicTable(ActionEvent actionEvent) {
        ...
        if (new PatientInSurgicalClinic().updatePatient(patient)) {
        ...
        /*jasper report*/
        new ReportsConroller().showUpdateReport("SURGICAL CLINIC",txtPatientID.getText(),
                txtPatientName.getText(),txtPatientAge.getText(),txtPatientReason.getText(),txtPatientIllness.getText(),
                txtPatientReports.getText(),txtPatientMedicines.getText(),lblClinicDoctorID.getText(),date);
    ...
    public void loadPatientDetails(ActionEvent actionEvent) {
        try {
            SearchPatien patient = new PatientInSurgicalClinic().getPatient(txtPatientID.getText());
