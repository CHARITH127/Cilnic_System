...
public class AddPatientToSurgicalClinicController {
    ...
    public void AddPAtientToTheClinic(ActionEvent actionEvent) {
        ...
        if (new PatientInSurgicalClinic().addPatientDirectly(patient)) {
            try {
                if (new PatientInSurgicalClinic().upDatePatientRefernece(reference)) {
