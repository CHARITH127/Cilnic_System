...
public class STDClinicFormContrller {
    public AnchorPane STDClinicContext;
    ...
    public JFXButton btnSTDClinicAdmit;
    public JFXButton btnSTDClinicUpdate;
    public Date date;
    ...
    public void AddPatientsToClinics(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../view/AddPatientToSTDClinic.fxml"));
        root=loader.load();
        AddPatientToSTDClinicController patient = loader.getController();
    ...
    public void SearchOnPatientHistory(ActionEvent actionEvent) {
        try {
            ObservableList<PatienHistoryTm> patientHistory =
                    new PatientInSTDClinic().getPatientHistory(txtpatientHistorySearch.getText());
    ...
    public void ToAdmit(ActionEvent actionEvent) {
        ...
        try {
            if (new PatientInSTDClinic().addPatientToSearchAdmission(patien)) {
    ...
    public void DeleteThePatientDetails(ActionEvent actionEvent) {
        ...
        try {
            if (new PatientInSTDClinic().deletePatientOnClinic(txtPatientID.getText())) {
    ...
    public void UpdateTheClinicTable(ActionEvent actionEvent) {
        ...
        if (new PatientInSTDClinic().updatePatient(patient)) {
        ...
        new ReportsConroller().showUpdateReport("STD CLINIC",txtPatientID.getText(),
                txtPatientName.getText(),txtPatientAge.getText(),txtPatientReason.getText(),txtPatientIllness.getText(),
                txtPatientReports.getText(),txtPatientMedicines.getText(),lblClinicDoctorID.getText(),date);
    ...
    public void loadPatienDetails(ActionEvent actionEvent) {
        try {
            SearchPatien patient = new PatientInSTDClinic().getPatient(txtPatientID.getText());
